package org.vwvm.agent.commons.vo;
...
public class UIConst {
	 ...
	 * URL子路径
	 */
	public final static String AREANAME = "area";
	
	/**
	 * 页面路径
	 */
	public final static String VIEWNAME = "view35a";
	 ...
	 *
	 */
	public static final String UP_ROOT = "up";
}